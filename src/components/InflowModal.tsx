...
const QUICK_INFLOW_PRESETS = [
  ...
  {
    label: '💛 MTN MoMo Inflow',
    title: 'MTN Mobile Money Received',
    category: 'Mobile Money Received' as InflowCategory,
    destination: 'mtn_mobile_money' as InflowDestination,
    source: 'Sender / Client',
    taxEstimate: 0,
    icon: Smartphone,
  },
  {
    label: '❤️ Airtel Money Inflow',
    title: 'Airtel Money Received',
    category: 'Mobile Money Received' as InflowCategory,
    destination: 'airtel_mobile_money' as InflowDestination,
    source: 'Sender / Client',
    taxEstimate: 0,
    icon: Smartphone,
  },
